...
final class TableController
{
    ...
    private function scopeWhere(string $table, array $user, array &$params): array
    {
        ...
        if ($table === 'assessment_scores' && in_array($user['role'], ['student', 'guardian'], true)) {
            $params['scope_school_id'] = $user['school_id'];
            $params['scope_user_id'] = $user['id'];
        ...
        if ($table === 'report_cards' && in_array($user['role'], ['student', 'guardian'], true)) {
            $params['scope_school_id'] = $user['school_id'];
            $params['scope_user_id'] = $user['id'];
            $access = $user['role'] === 'student'
        ...
        if ($table === 'report_card_items' && in_array($user['role'], ['student', 'guardian'], true)) {
            $params['scope_school_id'] = $user['school_id'];
            $params['scope_user_id'] = $user['id'];
            $access = $user['role'] === 'student'
        ...
        if ($table === 'student_invoices' && in_array($user['role'], ['student', 'guardian'], true)) {
            $params['scope_school_id'] = $user['school_id'];
            $params['scope_user_id'] = $user['id'];
            $access = $user['role'] === 'student'
        ...
        if ($table === 'student_invoice_items' && in_array($user['role'], ['student', 'guardian'], true)) {
            $params['scope_school_id'] = $user['school_id'];
            $params['scope_user_id'] = $user['id'];
            $access = $user['role'] === 'student'
        ...
        if (in_array($table, ['payments', 'payment_allocations'], true)
            && in_array($user['role'], ['student', 'guardian'], true)) {
            $params['scope_school_id'] = $user['school_id'];
            $params['scope_user_id'] = $user['id'];
            $allocationInvoice = $table === 'payments'
